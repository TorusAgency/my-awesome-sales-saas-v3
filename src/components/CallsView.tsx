...
import { Phone, Calendar, Clock, User, Video, Search } from 'lucide-react'; 
...
// Mock Meeting Data - Added duration and insights to one meeting
const mockMeetings: Meeting[] = [
  {
    ...
    duration: '45:00', // Changed format for consistency
    platform: 'Google Meet',
    insights: { // Added insights to this meeting
      ...
      overallScore: 88,
      scriptAdherenceScore: 9, // Assuming meetings can also have script adherence
      dealClosureProbability: 75,
      transcription: [ // Example transcription for a meeting
  ...
  },
  {
    ...
    duration: '30:00', // Changed format for consistency
    platform: 'Zoom',
    // No insights for this meeting
  },
];
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-8"> 
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Recent Calls</h3>
